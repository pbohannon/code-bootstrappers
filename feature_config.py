...
class FeatureConfig:
    ...
    def get_frontend_dev_dependencies(self, frontend_type: str = "react") -> Dict[str, str]:
        """Return frontend dev dependencies based on enabled features and frontend type."""
        deps = {}
        ...
        if self.testing:
            ...
            if frontend_type == "react":
                deps["@testing-library/react"] = "^16.0.0"
            elif frontend_type == "vue":
                deps["@testing-library/vue"] = "^8.0.0"
            elif frontend_type == "svelte":
                deps["@testing-library/svelte"] = "^5.0.0"
        ...
        if not self.minimal_tooling:
            ...
            # Framework-specific linting and formatting
            if frontend_type == "react":
                deps.update({
